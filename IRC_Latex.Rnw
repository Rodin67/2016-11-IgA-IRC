...
ggplot(inc_greffe, aes(x = annee, y = pourcentage, fill = pathologie)) + 
  ...
  ggtitle("Pourcentage de greffe par année sur le nombre de greffe total en France")
@
...
@
  ...
  On a la date de décès pour \Sexpr{table(!is.na(iga$ddc))[2]} (\Sexpr{round(table(!is.na(iga$ddc))[2]/nrow(iga)*100,1)}\%) patients.
...
<<results="asis">>=
print("Greffe 1")
print(xtable(addmargins(table(global_greffe$annee1)), digits = 1), table.placement = "H") # Nombre de greffe par année (1ère greffe)
print(xtable(round(prop.table(table(global_greffe$annee1))*100,1), digits = 1), table.placement = "H")

print("Greffe 2")
addmargins(table(global_greffe$annee2)) # Nombre de greffe par année (2e greffe)
round(prop.table(table(global_greffe$annee2))*100,0)
@
...
<<fig.height=4>>=
print("Greffe 1 (en mois)")
summary(global_greffe$DELAIARF1)
hist(global_greffe$DELAIARF1/12, main = "Temps entre la greffe 1 et l'arrêt du greffon", xlab = "Temps (en année)")
ggplot(global_greffe, aes(DELAIARF1/12)) +
  geom_density(fill = "red", alpha = 0.25, col = "red") +
  labs(title = "Courbe de densité", x = "Temps (en années)")
@
...
<<results="asis">>=
print(xtable(sort(table(global_greffe$ECHEC1, useNA = "always"), decreasing = T)[-1]), include.colnames =F, table.placement = "H")

"Pourcentage :"

print(xtable(round(prop.table(sort(table(global_greffe$ECHEC1), decreasing = T))*100,1)), include.colnames =F, table.placement = "H")
@
