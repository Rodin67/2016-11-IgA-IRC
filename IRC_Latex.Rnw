...
print(xtable(standdirect[order(standdirect$Ratio.ajuste, decreasing = T),]*10), table.placement = "H")
@
...
print(xtable(x[c(1:50),]), table.placement = "H")
print(xtable(x[c(51:99),]), table.placement = "H")
@
...
plotmeans(iga$age~iga$gr_bmi, gap=0, mean.labels= T, main = "Moyennes de l'âge avec intervalle de confiance - Maladie de Berger", xlab = "", ylab = "Âge")
...
summary(lm(iga$HBINI~iga$sex+iga$dfg))
@
