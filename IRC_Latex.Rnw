...
Nombre de patients ayant une date de greffe (Berger) : \Sexpr{table(!is.na(global_greffe$DINSCMED[global_greffe$iga==1]))[2]} (\Sexpr{round(prop.table(table(!is.na(global_greffe$DINSCMED[global_greffe$iga==1])))*100,1)[2]}\%)
