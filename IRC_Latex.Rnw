...
global_greffe2$greffe_METHOn <- ifelse(global_greffe2$gr_METHOn=="Greffe" | is.na(global_greffe2$liste_longue), "Greffe", "Dialyse")
...
<<results="asis">>=
descr_global("liste_longue", "SIDAn")
@
~\\
...
<<results="asis">>=
x <- table(global_greffe2$greffe_METHOn[global_greffe2$liste_longue=="Néphropathie à dépôts d'IgA"], global_greffe2$date_greffe[global_greffe2$liste_longue=="Néphropathie à dépôts d'IgA"])
